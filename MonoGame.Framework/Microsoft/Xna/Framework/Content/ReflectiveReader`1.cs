...
namespace Microsoft.Xna.Framework.Content
{
  internal class ReflectiveReader<T> : ContentTypeReader
  {
    ...
    {
      T obj = existingInstance == null ? (this.constructor == (ConstructorInfo) null ? (T) Activator.CreateInstance(typeof (T)) : (T) this.constructor.Invoke((object[]) null)) : (T) existingInstance;
