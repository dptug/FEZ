  ...
  public struct BoundingBox : IEquatable<BoundingBox>
  {
    ...
    public ContainmentType Contains(BoundingSphere sphere)
    {
      if ((double) sphere.Center.X - (double) this.Min.X >= (double) sphere.Radius && (double) sphere.Center.Y - (double) this.Min.Y >= (double) sphere.Radius && ((double) sphere.Center.Z - (double) this.Min.Z >= (double) sphere.Radius && (double) this.Max.X - (double) sphere.Center.X >= (double) sphere.Radius) && ((double) this.Max.Y - (double) sphere.Center.Y >= (double) sphere.Radius && (double) this.Max.Z - (double) sphere.Center.Z >= (double) sphere.Radius))
        return ContainmentType.Contains;
      double num1 = 0.0;
      double num2 = (double) sphere.Center.X - (double) this.Min.X;
      if (num2 < 0.0)
      {
      ...
      {
        double num3 = (double) sphere.Center.X - (double) this.Max.X;
        if (num3 > 0.0)
        {
          if (num3 > (double) sphere.Radius)
            return ContainmentType.Disjoint;
          num1 += num3 * num3;
        }
      }
      double num4 = (double) sphere.Center.Y - (double) this.Min.Y;
      if (num4 < 0.0)
      {
        if (num4 < -(double) sphere.Radius)
          return ContainmentType.Disjoint;
        num1 += num4 * num4;
      }
      else
      {
        double num3 = (double) sphere.Center.Y - (double) this.Max.Y;
        if (num3 > 0.0)
        {
          if (num3 > (double) sphere.Radius)
            return ContainmentType.Disjoint;
      ...
      double num5 = (double) sphere.Center.Z - (double) this.Min.Z;
      if (num5 < 0.0)
      {
        if (num5 < -(double) sphere.Radius)
          return ContainmentType.Disjoint;
        num1 += num5 * num5;
      }
      else
      {
        double num3 = (double) sphere.Center.Z - (double) this.Max.Z;
        if (num3 > 0.0)
        {
          if (num3 > (double) sphere.Radius)
            return ContainmentType.Disjoint;
      ...
      return num1 <= (double) sphere.Radius * (double) sphere.Radius ? ContainmentType.Intersects : ContainmentType.Disjoint;
    }
