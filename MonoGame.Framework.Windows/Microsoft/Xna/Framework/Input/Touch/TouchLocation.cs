...
namespace Microsoft.Xna.Framework.Input.Touch
{
  public struct TouchLocation : IEquatable<TouchLocation>
  {
    ...
    {
      return value1._id != value2._id || value1._state != value2._state || (value1._position != value2._position || value1._previousState != value2._previousState) || value1._previousPosition != value2._previousPosition;
    }
    ...
    internal bool UpdateState(TouchLocation touchEvent)
    {
      ...
      return this._state != this._previousState || (double) vector2.LengthSquared() > 1.0 / 1000.0;
    }
    ...
    {
      return this._id.Equals(other._id) && this._position.Equals(other._position) && this._previousPosition.Equals(other._previousPosition);
    }
