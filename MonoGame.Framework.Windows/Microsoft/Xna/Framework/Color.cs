...
namespace Microsoft.Xna.Framework
{
  ...
  public struct Color : IEquatable<Color>
  {
    ...
    public Color(Color color, int alpha)
    {
      ...
      this.G = color.G;
      this.B = color.B;
      this.A = (byte) MathHelper.Clamp((float) alpha, 0.0f, (float) byte.MaxValue);
    }
    ...
    {
      this._packedValue = 0U;
      this.R = (byte) MathHelper.Clamp((float) r, 0.0f, (float) byte.MaxValue);
      this.G = (byte) MathHelper.Clamp((float) g, 0.0f, (float) byte.MaxValue);
      this.B = (byte) MathHelper.Clamp((float) b, 0.0f, (float) byte.MaxValue);
      this.A = byte.MaxValue;
    }
    ...
    {
      return (int) a.A == (int) b.A && (int) a.R == (int) b.R && (int) a.G == (int) b.G && (int) a.B == (int) b.B;
    }
