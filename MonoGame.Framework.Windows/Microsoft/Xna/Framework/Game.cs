...
namespace Microsoft.Xna.Framework
{
  public class Game : IDisposable
  {
    ...
    private TimeSpan _targetElapsedTime = TimeSpan.FromSeconds(1.0 / 60.0);
    ...
    private class SortingFilteringCollection<T> : ICollection<T>, IEnumerable<T>, IEnumerable
    {
      ...
      private void ProcessRemoveJournal()
      {
        ...
        for (int index = 0; index < this._removeJournal.Count; ++index)
          this._items.RemoveAt(this._removeJournal[index]);
        this._removeJournal.Clear();
      }
