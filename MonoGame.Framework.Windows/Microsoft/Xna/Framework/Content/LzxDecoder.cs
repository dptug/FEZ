...
namespace Microsoft.Xna.Framework.Content
{
  ...
  {
    public static uint[] position_base = (uint[]) null;
    public static byte[] extra_bits = (byte[]) null;
    ...
    private class BitBuffer
    {
      ...
      public void EnsureBits(byte bits)
      {
        ...
        {
          int num1 = (int) (byte) this.byteStream.ReadByte();
          int num2 = (int) (byte) this.byteStream.ReadByte();
          int num3 = 16 - (int) this.bitsleft;
          this.buffer |= (uint) ((num2 << 8 | num1) << 16 - (int) this.bitsleft);
