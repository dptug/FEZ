...
namespace SharpDX
{
  ...
  public struct ViewportF : IEquatable<ViewportF>, IDataSerializable
  {
    ...
    public float AspectRatio
    {
      get
      {
        if (!MathUtil.WithinEpsilon(this.Height, 0.0f))
    ...
    {
      if (MathUtil.WithinEpsilon(this.X, other.X) && MathUtil.WithinEpsilon(this.Y, other.Y) && (MathUtil.WithinEpsilon(this.Width, other.Width) && MathUtil.WithinEpsilon(this.Height, other.Height)) && MathUtil.WithinEpsilon(this.MinDepth, other.MinDepth))
    ...
    {
      if (object.ReferenceEquals((object) null, obj) || !(obj is ViewportF))
        return false;
      else
        return this.Equals((ViewportF) obj);
    }
    ...
    public Vector3 Project(Vector3 source, Matrix projection, Matrix view, Matrix world)
    {
      ...
      if (!MathUtil.WithinEpsilon(a, 1f))
        vector3 /= a;
      vector3.X = (float) (((double) vector3.X + 1.0) * 0.5) * this.Width + this.X;
      vector3.Y = (float) ((-(double) vector3.Y + 1.0) * 0.5) * this.Height + this.Y;
