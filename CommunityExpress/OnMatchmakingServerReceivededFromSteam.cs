// Type: CommunityExpressNS.OnMatchmakingServerReceivededFromSteam
...
{
  internal delegate void OnMatchmakingServerReceivededFromSteam(uint request, ref gameserveritem_t callbackData);
}
